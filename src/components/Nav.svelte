...
<nav
  class="max-w-screen-lg w-full px-3 py-6 border-b-2 mx-auto flex justify-between items-center"
>
  <a href="/" class="flex items-center justify-between gap-x-4">
    <svg
      ...
      class="lucide lucide-code-square w-10 h-10"
...
<style>
  .menu-item {
    @apply text-center p-4 rounded-lg text-lg;
  }
  .menu-item:hover {
    @apply bg-gray-200;
  }
